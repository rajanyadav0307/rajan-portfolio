    ...
    categories: [
      {
        ...
        items: [
          ...
          { label: "Libraries", level: 70, note: "Boost, OpenSSL, Poco, ICU, GStreamer, OpenBlas, FFTW, OpenCV, Gstreamer, GTest" },
          { label: "Architectures", level: 80, note: "ARMv7-A, ARMv8-A, x86_64"},
          { label: "Design Patterns", level: 90, note: "RAII, Pimpl, Factory, Observer, Singleton, Strategy, Adapter, Decorator" }
      ...
      },
      {
        ...
        items: [
          ...
          { label: "CI/CD", level: 90, note: "GitHub Actions, Jenkins" }
        ]
      }
    ]
  },
